...
CHANGE country_id id INT NOT NULL AUTO_INCREMENT,
ADD PRIMARY KEY (id),
...
DROP COLUMN title_ua,
CHANGE title_ru title VARCHAR(150) NOT NULL,
CHANGE region_id id INT NOT NULL AUTO_INCREMENT,
ADD PRIMARY KEY (id),
...
DROP COLUMN area_ru,
CHANGE title_ru title VARCHAR(150) NOT NULL,
CHANGE region_id region_id INT NOT NULL,
CHANGE city_id id INT NOT NULL AUTO_INCREMENT,
ADD PRIMARY KEY (id),
ADD CONSTRAINT FK_CountryCity 
FOREIGN KEY (country_id) REFERENCES _countries(id),
ADD CONSTRAINT FK_RegionCity 
FOREIGN KEY (region_id) REFERENCES _regions(id),
ADD INDEX city_title(title);